<template>
  <Page id="page-privacy-policy">
    ...
    <PageSection id="genturis-privacy-google" aria-labelledby="genturis-privacy-google-title">
    ...
    <PageSection id="genturis-privacy-eservices" aria-labelledby="genturis-privacy-eservices-title">
    ...
    <PageSection id="genturis-privacy-access" aria-labelledby="genturis-privacy-access-title">
    ...
    <PageSection id="genturis-privacy-contact" aria-labelledby="genturis-privacy-contact-title">
    ...
    <PageSection id="genturis-privacy-links" aria-labelledby="genturis-privacy-links-title">
