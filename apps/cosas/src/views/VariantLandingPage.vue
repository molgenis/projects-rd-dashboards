<template>
  <Page id="page-variant-landing">
    ...
    />
    <PageSection id="page-variant-landing-about" aria-labelledby="page-variant-landing-about-title">
      <h2 id="page-variant-landing-about-title">About the Variant Database</h2>
      <p>....</p>
    </PageSection>
  </Page>
  <AppFooter />
