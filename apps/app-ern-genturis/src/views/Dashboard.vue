<template>
  <Page id="page-dashboard">
    ...
    <div class="dashboard-container" :loading="loading" v-else>
      <div id="ern-data-highlights" aria-labelledby="ern-highlights-title" class="dashboard-box width-full" >
        <p id="ern-highlights-title" class="visually-hidden">
          The following numbers provide a summary of participant enrollment for the ERN Genturis registry. This includes total patients to date, total number of actively enrolling countries, and the total number of healthcare providers enrolling patient.
        </p>
        <VizDataValueHighlights
          title="Summary of participant enrollement"
          :values="[]"
          :labels="[]"
        />
        <!-- <DataHighlightBox
      ...
      <DashboardSection id="viz-map" aria-labelledBy="viz-map-title">
